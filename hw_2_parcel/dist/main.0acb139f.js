...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"logic/mount.js":[function(require,module,exports) {
"use strict";
...
;
},{}],"logic/timer.js":[function(require,module,exports) {
"use strict";
...
function handleTime(event) {
  event.preventDefault(); // event.target.setAttribute("style", "display: none");
...
function startTimer() {
  if (_main.minTimer.value <= 0 && _main.secTimer.value <= 0) {
    clearInterval(handleTime);
  } else if (_main.secTimer.value <= 0) {
    _main.minTimer.value--;
    _main.secTimer.value = 59;
  } else {
    _main.secTimer.value--;
  }
}
...
//     };
// }
},{"./main.js":"logic/main.js"}],"logic/luxon.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = exports.Zone = exports.Settings = exports.LocalZone = exports.InvalidZone = exports.Interval = exports.Info = exports.IANAZone = exports.FixedOffsetZone = exports.Duration = exports.DateTime = void 0;
  ...
  _createClass(IANAZone, [{
    ...
    value: function offset(ts) {
      var date = new Date(ts),
          ...
          _ref4 = dtf.formatToParts ? partsOffset(dtf, date) : hackyOffset(dtf, date),
...
function getCachedRTF(locString) {
  ...
  var cacheKeyOpts = _objectWithoutPropertiesLoose(opts, ["base"]); // exclude `base` from the options
...
var Duration = /*#__PURE__*/function () {
  ...
  _createClass(Duration, [{
    ...
    value: function equals(other) {
      ...
      var _iterator4 = _createForOfIteratorHelper(orderedUnits),
          _step4;
...
function highOrderDiffs(cursor, later, units) {
  ...
  for (var _i5 = 0, _differs = differs; _i5 < _differs.length; _i5++) {
    var _differs$_i = _slicedToArray(_differs[_i5], 2),
        unit = _differs$_i[0],
...
function explainFromTokens(locale, input, format) {
  ...
  if (disqualifyingUnit) {
    ...
    var _buildRegex = buildRegex(units),
        ...
        matches = _match7[1],
        _ref31 = matches ? dateTimeFromMatches(matches) : [null, null],
...
function adjustTime(inst, dur) {
  ...
  dur = (_dur2 = dur).shiftTo.apply(_dur2, _toConsumableArray(keys));
  var oPre = inst.o,
...
function toTechTimeFormat(dt, _ref33) {
  var _ref33$suppressSecond = _ref33.suppressSeconds,
      suppressSeconds = _ref33$suppressSecond === void 0 ? false : _ref33$suppressSecond,
      _ref33$suppressMillis = _ref33.suppressMilliseconds,
      suppressMilliseconds = _ref33$suppressMillis === void 0 ? false : _ref33$suppressMillis,
      includeOffset = _ref33.includeOffset,
      _ref33$includeZone = _ref33.includeZone,
      includeZone = _ref33$includeZone === void 0 ? false : _ref33$includeZone,
      _ref33$spaceZone = _ref33.spaceZone,
      spaceZone = _ref33$spaceZone === void 0 ? false : _ref33$spaceZone,
      _ref33$format = _ref33.format,
      format = _ref33$format === void 0 ? "extended" : _ref33$format;
...
function quickDT(obj, zone) {
  ...
  var _iterator6 = _createForOfIteratorHelper(orderedUnits$1),
      _step6;
...
function diffRelative(start, end, opts) {
  ...
  var _iterator7 = _createForOfIteratorHelper(opts.units),
      _step7;
  ...
  _createClass(DateTime, [{
    ...
    */
    ...
    value: function fromObject(obj) {
      ...
      var _iterator8 = _createForOfIteratorHelper(units),
          _step8;
...
},{}],"logic/datecalc.js":[function(require,module,exports) {
"use strict";
...
},{"./luxon.js":"logic/luxon.js"}],"logic/utils.js":[function(require,module,exports) {
"use strict";
...
},{}],"logic/date.js":[function(require,module,exports) {
"use strict";
...
function handleCalcDates(event) {
  _main.dateCalcResult.innerHTML = "";
  event.preventDefault();
  ...
  if (firstDate && secondDate) {
    ...
    _main.dateCalcResult.innerHTML = (0, _datecalc.diffToHtml)(diff);
  } else _main.dateCalcResult.innerHTML = (0, _utils.formatError)("Для расчета промежутка необходимо заполнить оба поля"); // 5

}

;
},{"./datecalc.js":"logic/datecalc.js","./utils.js":"logic/utils.js","./main.js":"logic/main.js"}],"logic/main.js":[function(require,module,exports) {
'use strict';
/** Блок import/export */
...
exports.secTimer = exports.minTimer = exports.dateCalcResult = void 0;
...
exports.dateCalcResult = dateCalcResult;
var timeForm = document.getElementById("time");
var switchArea = document.getElementById("switch");
...
exports.secTimer = secTimer;
dateCalcForm.addEventListener("submit", _date.handleCalcDates);
timeForm.addEventListener("submit", _timer.handleTime);
switchArea.addEventListener("click", function (event) {
  (0, _mount.preMount)(event);
});
var sound = new Howl({
  src: ['sound.mp3']
});
sound.play();
},{"./mount.js":"logic/mount.js","./timer.js":"logic/timer.js","./date.js":"logic/date.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","logic/main.js"], null)
//# sourceMappingURL=/main.0acb139f.js.map